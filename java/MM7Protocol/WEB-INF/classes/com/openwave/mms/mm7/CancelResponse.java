 ...
 *  CancelResponse message that MMSC sends to the application in response
 *  to a vaild CancelRequest message {@link SubmitRequest}. 
 *  <p>
 *  When the API receives a CancelResponse from MMSC, it converts the SOAP
 *  response to a <code>CancelResponse</code> object and passes it back as 
 ...
 */
public final class CancelResponse extends Response {

    /**
     *  Package-private constructor. The CancelResponse is created by the API when it
     *  receives a response to the CancelRequest from the relay.
     *
     *  @param header The SOAP header.
     *  @param response The CancelResponse as a SOAP method object.
     ...
     */
    CancelResponse( SOAPHeader header,
