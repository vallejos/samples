...
class migGame {
	...
	private $contentType;
	private $dbc;
	private $logFile = "/home/kamus/Web/mig/logs/game.class.log";
...
*/
    ...
    public function downloadContent($ftpCon) {
        $this->dirToWrite = TMP_DIR_JG."/" . $this->uniqueId;
        if (!is_writable(TMP_DIR_JG)) {
            die("ERROR: ".TMP_DIR_JG." is not writable\n");
        } else {
