...
switch($step) {
	...
	case 1:
		...
		if(soportaContenidoPorTipo ( $db, $ua, 31 )){
			...
			$top->start(2,OPERADORA_MCM,NOMBRE_MCM);
			$soportaJuegos = true;
		}
		...
		foreach($juegos as $item){
			$href = "game_desc.php?b=g&amp;step=1&amp;cat=$idCat&amp;p=$pagina&amp;id=".$item['id'];
	...
	$texto = new MensajeDescarga($url,$url_no,"home.php", $type, $idCont);
