...
DEFINE("TEMPORAL_FOLDER","./wallpapers_tmp/temp/");
			...
			switch($validtype){
				...
				case 'jpg' 	:
					if($this->imtype == 'gif' or $this->imtype == 'png') {
						...
						$image = $this->replaceTransparentWhite($this->im);
						imageJPEG($image,TEMPORAL_FOLDER."/".$this->imname.".jpg");
					} else
					imageJPEG($this->im,TEMPORAL_FOLDER."/".$this->imname.".jpg");
					break;
				case 'gif' :
					imageGIF($this->im,TEMPORAL_FOLDER."/".$this->imname.".gif");
					break;
				case 'png' :
					imagePNG($this->im,TEMPORAL_FOLDER."/".$this->imname.".png");
					break;
				case 'wbmp' :
					imageWBMP($this->im,TEMPORAL_FOLDER."/".$this->imname.".wbmp");
					break;
				case 'swf' :
					$this->imageSWF($this->im,TEMPORAL_FOLDER."/".$this->imname.".swf");
					break;
