...
define("HOST_PREVIEW", "10.0.0.241");
define("USR_PREVIEW", "sms");
define("PASS_PREVIEW", "gagsUrt]");
...
// FOLDERS
$destino_dir = $globalIncludeDir."/zip";
//$work_dir = "temp";
$origen_dir = "";
$template_dir = $globalIncludeDir."/templates";
$zip_path = $globalIncludeDir."/zip";
$watermark_dir = $globalIncludeDir."/watermark";
//$targetDir = $work_dir;
