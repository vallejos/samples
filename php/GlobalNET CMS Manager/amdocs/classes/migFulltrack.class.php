...
class druttFulltrack {
    ...
    private $contentType;
    private $dbc;
    private $logFile = "/mnt/www/tools/cms/amdocs/logs/fulltrack.class.log";
    ...
    // constructor
    function __construct($dbc, $debug=FALSE, $marca="", $festivo="") {
...
XML;
        ...
        foreach($langs as $lang) {
              $country = explode("-", $lang);
            $country = $country[1];
            if(in_array($country, $this->langs)) {
