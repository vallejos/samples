...
class Seccion extends WapComponent{
	...
	function Seccion($titulo, $align = "center", $font_size = NORMAL_FONT_SIZE, $tipo_seccion = SECCION_NORMAL){
		...
		if($align == "") {
			$align = "center"; //si se deja el align vacío, el código deja el atributo con un valor vacío en el código generado y 
		...
		$this->extra_class = "";
		$this->title_extra_class = "";
	}

	function setTitleExtraClass($css) {
		$this->title_extra_class = $css;
	}
	...
	function Display(){
		...
		$html = str_replace("#TITLE-EXTRA-CLASS#", $this->title_extra_class, $html);
		/**
