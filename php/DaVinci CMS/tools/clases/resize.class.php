...
class ResizeJpg{
	...
	public function process(){
		...
		$this->imgDest=ImageCreateTrueColor( intval($this->anchoMax), intval($this->altoMax) ) or die('Problema en la creación de la imgen :(');
		...
		if($this->imgWatermark != null){
			imagecopy($this->imgDest, $this->imgWatermark, $this->watermarkLeft, $this->watermarkTop,  0, 0, $this->watermarkWidth, $this->watermarkHeight) or die("la mezcla salió pal orto");
		}
	}
